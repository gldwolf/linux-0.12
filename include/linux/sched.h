...
#define set_base_asm(ldt,base) set_base( ((char *)&(ldt)) , base )
#define set_limit_asm(ldt,limit) set_limit( ((char *)&(ldt)) , (limit-1)>>12 )
...
#define get_base_asm(ldt) get_base( ((char *)&(ldt)) )
